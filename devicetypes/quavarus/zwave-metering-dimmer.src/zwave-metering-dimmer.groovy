 ...
 */
metadata {
	definition (name: "Z-Wave Metering Dimmer", namespace: "quavarus", author: "SmartThings") {
		capability "Switch"
		capability "Polling"
	...
	tiles(scale: 2) {
		...
		valueTile("energy", "device.energy", height: 2, width: 2) {
			state "default", label:'${currentValue} kWh'
		}
		standardTile("reset", "device.energy", inactiveLabel: false, decoration: "flat", height: 2, width: 2) {
	...
	main(["switch","energy"])
	details(["switch", "energy", "refresh", "reset"])
}
